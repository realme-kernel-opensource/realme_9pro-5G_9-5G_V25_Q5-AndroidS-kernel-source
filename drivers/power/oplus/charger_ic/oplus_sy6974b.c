...
int sy6974b_suspend_charger(void)
{
	...
	if (chip->real_suspend_6974b) {
		...
		return sy6974b_disable_charging();
	}
}
...
int sy6974b_unsuspend_charger(void)
{
	...
	if (chip->real_suspend_6974b) {
		...
		return sy6974b_enable_charging();
	}
}
...
void sy6974b_suspend_for_usbtemp(bool en)
{
	int rc = 0;
	struct chip_sy6974b *chip = charger_ic;
...
struct oplus_chg_operations  sy6974b_chg_ops = {
	.dump_registers = sy6974b_dump_registers,
	...
	.suspend_for_usbtemp = sy6974b_suspend_for_usbtemp,
