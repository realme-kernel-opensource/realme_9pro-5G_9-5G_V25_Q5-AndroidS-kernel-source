...
extern int opluschg_get_typec_cc_orientation(union power_supply_propval *val);
...
static ssize_t adapter_power_show(struct device *dev, struct device_attribute *attr,
		char *buf)
{
	struct oplus_chg_chip *chip = NULL;
