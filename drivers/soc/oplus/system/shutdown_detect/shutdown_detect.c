...
{
	if (0 != dump_kmsg(LEGACY_PARTITION_OPLUSRESERVE3_LINK,
		...
		if (0 != dump_kmsg(OPLUS_PARTITION_OPLUSRESERVE3_LINK,
			...
			if (0 != dump_kmsg(DERIVED_PARTITION_OPLUSRESERVE3_LINK,
					   DERIVED_SHUTDOWN_KMSG_OFFSET, &shutdown_kmsg_dumper)) {
