...
static inline int is_uxwork(struct work_struct *work)
{
	return false;
}
static inline int set_uxwork(struct work_struct *work)
{
	return false;
}
static inline int unset_uxwork(struct work_struct *work)
{
	return false;
}
