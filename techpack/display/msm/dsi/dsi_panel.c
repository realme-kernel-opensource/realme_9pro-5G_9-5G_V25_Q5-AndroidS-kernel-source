...
static int dsi_panel_power_on(struct dsi_panel *panel)
{
	...
	if(is_project(21707) || is_project(21708) || is_project(0x216E9) || is_project(0x216EA) || is_project(21629) || is_project(0x2162B)) {
...
static int dsi_panel_power_off(struct dsi_panel *panel)
{
	...
	if((mode == MSM_BOOT_MODE__FACTORY) || (mode == MSM_BOOT_MODE__RF) || (mode == MSM_BOOT_MODE__WLAN)) {
		if(!strcmp(panel->name,"dsjm ili7807s 21707 fhd plus mipi panel with DSC") && tp_reset_gpio_notifier) {
